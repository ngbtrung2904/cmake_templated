...
// configuration step. It creates a namespace called `cmake_templated`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_templated::cmake::project_name, cmake_templated::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_templated::cmake::project_version);
      return EXIT_SUCCESS;
    }
